Arastta Documentation
=========================
This repository contains the source of the Arastta documentation, currently accessible at [arastta.org/docs](http://arastta.org/docs).
...
If you would like a local copy of the documentation, you can either [download it](https://github.com/arastta/docs/archive/master.zip) or you can clone the reopistory by running the follwing command:

~~~ .bash
git clone git://github.com/arastta/docs docs
~~~
...
You are also very welcome to make any suggestions or report any kind of problem with the documentation by opening a new [Issue](https://github.com/arastta/docs/issues/new).
...
* There are some reserved names that can’t be used for anything but the scope they are intended for:
    ...
    * **MENU.md**: The menu file contains the navigation structure of the documentation. The menu is represented as sidebar in the [Arastta Documentation](http://arastta.org/docs) page. Menu links must not contain the file extesion which means not "how-to-install.md" but "how-to-install".

    * **INDEX.md**: This file defines the content of the home page of [documentation](http://arastta.org/docs).

    * **_images**: When the document requires images, they can be placed into the respected `_images` folder.

* Every document must containt an H1 (`=`) text at the beginning/top of the file.
...
If you have any question feel free to open an [Issue](https://github.com/arastta/docs/issues/new).
